...
UPDATE `gossip_menu_option` SET `OptionBroadcastTextID`=11869 WHERE `MenuID`=1541 AND `OptionID`=1;
...
(15,1541,0,0,0,61,0,0,0,0,'',0,0,0,'',"Group 0: Show Gossip Option 0 if player is not in group"), -- 61 = CONDITION_GROUP_STATUS (this assembly has CONDITION_CHROMIE_TIME at 60)
...
(15,1541,1,0,0,61,0,1,0,0,'',0,0,0,'',"Group 0: Show Gossip Option 1 if player is in group"); -- 61 = CONDITION_GROUP_STATUS (this assembly has CONDITION_CHROMIE_TIME at 60)
