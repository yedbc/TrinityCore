...
// The Voidspire boss 2: Vorasius -- DungeonEncounter 3177 (DB2 @68887, CONFIRMED).
...
struct boss_vorasius : public BossAI
{
    boss_vorasius(Creature* creature) : BossAI(creature, DATA_VORASIUS) { }
...
{
    RegisterTheVoidspireCreatureAI(boss_vorasius);
}
