...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_TUTORIALS,
    CHAR_INS_TUTORIALS,     // plain INSERT form carried over from the warband parent; superseded by CHAR_REP_TUTORIALS below (kept so the id is not silently dropped by the merge)
    CHAR_REP_TUTORIALS,
    CHAR_UPD_TUTORIALS,
    CHAR_DEL_TUTORIALS,
